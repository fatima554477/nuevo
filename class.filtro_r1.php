...
$sWhere2.="  $tables.RFC_PROVEEDOR = '".$search['RFC_PROVEEDOR']."' OR ";}
...
$sWhere2.="  $tables.NUMERO_EVENTO1 = '".$search['NUMERO_EVENTO1']."' OR ";}
...
$sWhere2.="  $tables.MONTO_DE_COMISION = '".$search['MONTO_DE_COMISION']."' OR ";}
...
IF($sWhere2!=""){
			...
			$sWhere3  = ' '.$sWhereCC.' where (
			 02SUBETUFACTURA.NUMERO_EVENTO = "'.$NUMERO_EVENTO.'" AND '.$sWhere33.' ) ';			
		}ELSE{
			//$sWhereCC = substr($sWhereCC,0,-4);			
		$sWhere3  = ' '.$sWhereCC.'  where ( 02SUBETUFACTURA.NUMERO_EVENTO = "'.$NUMERO_EVENTO.'")  ';
		}
